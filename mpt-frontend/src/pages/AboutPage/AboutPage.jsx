...
export function AboutPage() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="about-page__text">Do tej pory za pośrednictwem naszego portalu nawiązanych zostało ponad 2000 współprac, dzięki którym obie strony zyskały satysfakcjonujące korzyści.</div>
      <div style={{ margin: '2rem 0' }} />
