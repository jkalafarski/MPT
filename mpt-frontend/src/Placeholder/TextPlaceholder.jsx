...
const css = {
  placeholder: 'mpt-text-placeholder',
};
...
export function TextPlaceholder() {
  return (
    <div className={css.placeholder}>
      ...
      fermentum in, dolor. Pellentesque facilisis. Nulla imperdiet sit amet magna. Vestibulum
      dapibus, mauris nec malesuada fames ac turpis velit, rhoncus eu, luctus et interdum adipiscing
      wisi. Curabitur et ligula. Ut molestie a, ultricies porta urna. Vestibulum commodo volutpat a,
